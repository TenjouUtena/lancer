...
export function CustomerEdit({ customer, onClose }) {
    const [formData, setFormData] = useState({
        ...
        discordLink: customer.discordLink || '',
        furAffinityName: customer.furAffinityName || '',
        furAffinityLink: customer.furAffinityLink || '',
        twitterName: customer.twitterName || '',
        twitterLink: customer.twitterLink || '',
        instagramName: customer.instagramName || '',
        instagramLink: customer.instagramLink || '',
        telegramName: customer.telegramName || '',
        telegramLink: customer.telegramLink || '',
        otherPlatformName: customer.otherPlatformName || '',
        otherPlatformLink: customer.otherPlatformLink || ''
    });
